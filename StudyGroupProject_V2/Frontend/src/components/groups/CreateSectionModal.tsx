...
export default function CreateSectionModal({ isOpen, onClose, groupId, onSuccess }: CreateSectionModalProps) {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            for (const file of Array.from(files)) {
                // Create a temporary section id placeholder for upload
                // We'll use the group id as prefix
                const res = await sectionsAPI.generatePresignUrlAttachment(groupId, { fileName: file.name, contentType: file.type });
    ...
    const handleSubmit = async () => {
        ...
        try {
            await sectionsAPI.createSection(groupId, {
